from dsrag.dsparse.file_parsing.non_vlm_file_parsing import (
...
def create_kb_from_directory(
    ...
    # create a new KB
    kb = KnowledgeBase(
        kb_id, title=title, description=description, language=language, exists_ok=False
    )
